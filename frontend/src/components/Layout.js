...
const navItems = [
  ...
  },
  {
    ...
    children: [
      ...
      { title: 'Exchange Gain/Loss', path: '/exchange-gain-loss' },
    ],
  },
  {
    title: 'Accounting',
    ...
    children: [
      ...
      { title: 'Cash Ledger', path: '/accounting/ledger/cash' },
      { title: 'Petty Cash Ledger', path: '/accounting/ledger/petty-cash' },
      { title: 'Bank Ledger', path: '/accounting/ledger/bank' },
